...
const WINDOW_TITLE: &str = "09. Fixed functions";
...
impl ApplicationHandler for VulkanApp {
    ...
    fn resumed(&mut self, event_loop: &winit::event_loop::ActiveEventLoop) {
        ...
        VulkanApp::create_graphics_pipeline(&device, &swapchain_data);
...
impl VulkanApp {
    ...
    fn create_logical_device(
        ...
        let mut vk13_required_features =
    ...
    fn create_graphics_pipeline(device: &ash::Device, swapchain_data: &SwapchainData) {
        ...
        let pipeline_rendering_info = vk::PipelineRenderingCreateInfo::default()
            .color_attachment_formats(&[swapchain_data.surface_format.format]);
