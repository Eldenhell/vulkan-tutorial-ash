...
const WINDOW_TITLE: &str = "08. Shader modules";
...
impl ApplicationHandler for VulkanApp {
    ...
    fn resumed(&mut self, event_loop: &winit::event_loop::ActiveEventLoop) {
        ...
        VulkanApp::create_graphics_pipeline(&device);
...
impl VulkanApp {
    ...
    fn create_graphics_pipeline(device: &ash::Device) {
        ...
        let _shader_stages = VulkanApp::get_pipeline_shader_stages_info(&shader_module);
