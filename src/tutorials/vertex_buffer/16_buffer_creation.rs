...
const WINDOW_TITLE: &str = "16. Vertex buffer creation";
...
impl ApplicationHandler for VulkanApp {
    ...
    fn resumed(&mut self, event_loop: &winit::event_loop::ActiveEventLoop) {
        ...
        let (vertex_buffer, vertex_buffer_memory) =
            VulkanApp::create_vertex_buffer(&self.instance, &device, &self.physical_device);
...
impl VulkanApp {
    ...
    fn create_vertex_buffer(
        ...
        let vertex_buffer_memory = VulkanApp::allocate_memory(
            instance,
            device,
            physical_device,
